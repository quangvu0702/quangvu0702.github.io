...
```python
!jupyter nbconvert --to markdown 2022-09-21-Blogging-with-Jupyter-Notebooks.ipynb --output-dir=_port
```
...
```
    ...
    '001 Blogging with Jupyter Notebooks.ipynb'   _config.yml   index.md
     404.html                                     Gemfile       [0m[01;34mnbs[0m/
     about.md                                     [01;34mimages[0m/       [01;34m_posts[0m/
     [01;34massets[0m/                                      [01;34m_includes[0m/    README.md
